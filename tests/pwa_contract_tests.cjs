...
assert.equal(app.version, '0.31.0');
...
for (const required of ['manifest.webmanifest', 'runtime-config.js', 'runtime.js?v=0.31.0', 'pwa.js?v=0.31.0', 'equation-builder.js?v=0.31.0', 'math-keyboard.js?v=0.31.0', 'pwaBanner']) {
