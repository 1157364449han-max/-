...
当前版本：**0.35.0**。仓库中的部署状态以 [Actions](https://github.com/1157364449han-max/-/actions) 的实际结果为准，上传源码不代表网页已经上线。

## 使用能力与边界

0.35.0 参数栏先选择函数或方程，再编辑主曲线、动直线或附加曲线/函数；按稳定对象编号原位更新。输入表达式随图稿保存，常见分数、根式与 π 倍数优先以数学形式显示，无法恢复精确形式的动态读数标注近似号。
