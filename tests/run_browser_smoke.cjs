...
if(!suites.length)suites.push('cloud_primary','cloud_vision','latex_tangent','curve_edit_tangent','additive_conic_snap','focus_chord','derived_construction','one_stop_solver','desktop_layout','dependent_motion','named_points','reflected_chord','structured_input','conic_quick_tools','pwa','mobile_touch','solve_switch','photo_ocr','extreme_highlight');
