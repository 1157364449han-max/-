module.exports=async({page,context,assert,screenshot})=>{
  ...
  await context.route('**/runtime-config.js',route=>route.fulfill({contentType:'application/javascript',body:`window.DONGJIEXI_CONFIG=Object.freeze({version:'0.21.0',deployment:'web',apiBase:'',apiEnabled:false,requiresAuth:false});`}));
