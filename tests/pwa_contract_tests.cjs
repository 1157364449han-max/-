...
assert.equal(app.version, '0.26.0');
...
for (const required of ['manifest.webmanifest', 'runtime-config.js', 'runtime.js?v=0.26.0', 'pwa.js?v=0.26.0', 'equation-builder.js?v=0.26.0', 'math-keyboard.js?v=0.26.0', 'pwaBanner']) {
