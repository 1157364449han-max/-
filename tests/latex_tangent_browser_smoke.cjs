module.exports=async({page,context,assert,screenshot})=>{
  ...
  await context.route('**/runtime-config.js',route=>route.fulfill({contentType:'application/javascript',body:"window.DONGJIEXI_CONFIG={version:'0.23.1',deployment:'web',apiEnabled:false};"}));
